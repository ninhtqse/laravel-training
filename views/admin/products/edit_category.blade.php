            ...
            <div class="col-sm-12 portlets">
                <div class="widget">
                    ...
                    <div class="widget-content padding">
                        <form role="form" id="contactForm" action="{{route('edit_category', $results->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label>Name</label>
                                <input type="text" class="form-control" name="categories[name]" value="{{$results->name}}" >
                            </div>
