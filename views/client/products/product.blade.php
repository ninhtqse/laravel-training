...
<head>
	...
	<link rel='icon' type='image/png' href='../client_html/img/203e1caf5c843bba012315ffba1ad970.png' />
	<link rel='apple-touch-icon' sizes='180x180' href='../client_html/img/203e1caf5c843bba012315ffba1ad970.png' />
	<link rel='apple-touch-icon-precomposed' href='../client_html/img/203e1caf5c843bba012315ffba1ad970.png' />
	...
	<noscript><iframe src="../client_html/http://www.googletagmanager.com/ns.html?id=GTM-5JX8TL" height="0" width="0"
		...
		window.NREUM || (NREUM = {}), __nr_require = function (t, e, n) {
			...
			2: [function (t, e, n) {
				...
				try {
					...
					"stack" in h && (t(13), t(12), "addEventListener" in window && t(6), s.xhrWrappable && t(
						14), d = !0)
				}
			...
			4: [function (t, e, n) {
				...
				if (w[v] && y.xhrWrappable) {
					...
					S.on(f, r), b.on(p, r), M.on(p, r), S.on(d, o), b.on(l, o), M.on(l, o), S.buffer([f, d,
						...
						.buffer([f]), b.buffer(["propagate", p, l, "executor-err", "resolve" + c]), C.buffer([
							f, "no-" + f
						]), M.buffer(["new-jsonp", "cb-start", "jsonp-error", "jsonp-end"]), a(P, "send-xhr" +
							c), a(S, "xhr-resolved"), a(S, "xhr-done"), a(N, m + c), a(N, m + "-done"), a(M,
							"new-jsonp"), a(M, "jsonp-end"), a(M, "cb-start"), E.on("pushState-end", i), E.on(
			...
			5: [function (t, e, n) {
				...
				if (window.performance && window.performance.timing && window.performance.getEntriesByType) {
					...
					}), u in window.performance && (window.performance["c" + s] ? window.performance[u](f,
						function (t) {
			...
			6: [function (t, e, n) {
				...
				e.exports = a, "getPrototypeOf" in Object ? (r(document), r(window), r(u.prototype)) : u
					.prototype.hasOwnProperty(f) && (o(window), o(u.prototype)), a.on(f + "-start", function (
						t, e) {
						var n = t[1],
			...
			9: [function (t, e, n) {
					...
					if (r) {
						...
						if (o) {
							...
							if (a) {
								...
								if (d) {
									var p = {};
									u.inPlace(f.parent, [f.key], "cb-", p), t.addEventListener("load", e, !1),
										t.addEventListener("error", n, !1), s.emit("new-jsonp", [t.src], p)
								}
							}
						}
					}
				...
				if (e.exports = s, o()) {
					...
					Node && Node.prototype && Node.prototype.appendChild ? u.inPlace(Node.prototype, l,
						"dom-") : (u.inPlace(HTMLElement.prototype, l, "dom-"), u.inPlace(HTMLHeadElement
						.prototype, l, "dom-"), u.inPlace(HTMLBodyElement.prototype, l, "dom-")), s.on(
						"dom-start",
						function (t) {
							r(t[0])
						})
			...
			13: [function (t, e, n) {
				...
				function o(t, e, n) {
					this.method = n, this.timerDuration = isNaN(t[1]) ? 0 : +t[1], t[0] = a(t[0], "fn-", this,
						n)
				}
				var i = t("ee").get("timer"),
					...
					f = "-start",
					d = "-";
				e.exports = i, a.inPlace(window, [c, "setImmediate"], c + d), a.inPlace(window, [s], s + d), a
			...
			14: [function (t, e, n) {
				...
				if (s(l, x), x.prototype = l.prototype, d.inPlace(x.prototype, ["open", "send"], "-xhr-", c),
				...
				function r(t) {
					...
					if (!this.ended) {
						...
						e.aborted || (n.duration = a.now() - this.startTime, this.loadCaptureCalled || 4 !== t
							.readyState ? null == e.status && (e.status = 0) : i(this, t), n.cbTime = this
				...
				if (a.xhrWrappable) {
					...
					a.features.xhr = !0, t(14), t(7), f.on("new-xhr", function (t) {
						...
						this.startTime = a.now(), this.listener = function (t) {
							try {
								"abort" !== t.type || o.loadCaptureCalled || (o.params.aborted = !
									0), ("load" !== t.type || o.called === o.totalCbs && (o
									.onloadCalled || "function" != typeof e.onload)) && o.end(
									e)
							} catch (n) {
								try {
									f.emit("internal-error", [n])
						...
						this.cbTime += t, e ? this.onloadCalled = !0 : this.called += 1, this
							.called !== this.totalCbs || !this.onloadCalled && "function" == typeof n
							.onload || this.end(n)
						...
						e instanceof w && "load" === t[0] && f.emit("xhr-load-removed", [t[1], t[2]],
							e)
					}), f.on("fn-start", function (t, e, n) {
						e instanceof w && ("onload" === n && (this.onload = !0), ("load" === (t[0] &&
						...
						function e(t, e) {
							var n = !1;
							return e.newrelicHeader && (t.set("newrelic", e.newrelicHeader), n = !0),
						...
						var n, r = t[1] || {};
						"string" == typeof t[0] ? n = t[0] : t[0] && t[0].url ? n = t[0].url : window
			...
			17: [function (t, e, n) {
				...
				e.exports = function (t) {
					...
					!o.port && i[1] && (o.port = i[1].split("index.html")[0].split("@").pop().split(":")[
							1]), o.port && "0" !== o.port || (o.port = "https" === i[0] ? "443" : "80"), o
						.hostname = e.hostname || n.hostname, o.pathname = e.pathname, o.protocol = i[0],
			...
			18: [function (t, e, n) {
				function r(t, e) {
					...
					return "json" === n && null !== e ? e : "arraybuffer" === n || "blob" === n || "json" ===
						n ? o(t.response) : "text" === n || "" === n || void 0 === n ? o(t.responseText) :
						void 0
				}
				var o = t(20);
				e.exports = r
			...
			24: [function (t, e, n) {
				function r() {
					...
					for (var o, i = "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx", a = "", c = 0; c < i.length; c++)
						o = i[c], "x" === o ? a += t().toString(16) : "y" === o ? (o = 3 & t() | 8, a += o
							.toString(16)) : a += o;
					return a
				}
			...
			"wrap-function": [function (t, e, n) {
				function r(t, e) {
					...
					function r(t, e, r, o, i) {
						...
						for (u = 0; u < e.length; u++) s = e[u], c = t[s], a(c) || (t[s] = n(c, f ? s + r : r,
							o, s, i))
					}
				...
				var f = t("ee"),
					...
					h = !1;
				e.exports = r, e.exports.wrapFunction = c, e.exports.wrapInPlace = s, e.exports.argsToArray =
					u
			}, {}]
		}, {}, ["loader", 2, 16, 5, 3, 4]);;
		NREUM.loader_config = {
...
<body class="tempTop template">
	...
	<script type="text/javascript">
		var url =
			"https\u003a\u002f\u002ftrack.thebase.in\u002findex.php\u003fdc\u005faction\u003daccess\u002findex\u0026type\u003d2\u0026view\u005fshop\u005fid\u003dnaughtyboy-base-shop\u0026url\u003dhttp\u00253A\u00252F\u00252Fwww.beepsheepshamp.com\u00252Fcategories\u00252F1150353\u0026time\u003d1640654139";
	...
	<div id="layer_board_area">
		...
		<div class="layer_board">
			<p><a href=https://apps.apple.com/jp/app/beep-sheep-shamp/id1559411993" target="_blank"><img
						src="../client_html/img/4e57e958c69587ba6806fac02ddb362b.png"
						class="pc"><img
						src="../client_html/img/e2d0de3c41568de8731e5ff8a496abed.png"
						class="sp"></a></p>
		</div>
	</div>
	<!-- //layer_board -->
	...
	<div id="shoulder">
		<div id="shoulderCol">
			<p class="txt"><img src="../client_html/img/shop/shoulder_txt.png"></p>
			...
			<div class="btnBox">
					...
					<ul class="clearfix">
						<li class="base" style="visibility: hidden;"><a target="_blank" rel="nofollow"
								href=https://thebase.in/?from=naughtyboy-base-shop&amp;p=shop"><img
									src="../client_html/img/base.png" alt="ネットショップを開設するならBASE" title="BASE" height="30"></a>
						</li>
				...
				<p class="searchMenu"><a class="inline fade" href="../client_html/#searchBox"><img
	...
	<div id="headWrapper">
		<header id="mainHeader">
			<div id="headCol">
				...
				<h1><a href="../client_html/../index.html" id="logo"><img class="logoImage"
				...
				<script type="text/javascript">
					$(function () {
						$("header #headCol #navi ul li.mens a").load("../index.html");
						$("header #headCol #navi ul li.mens ul").load("1463951.html#categoryList ul li");
						$("header #headCol #navi ul li.ladies a").load("../index.html");
						$("header #headCol #navi ul li.ladies ul").load("1463950.html#categoryList ul li");
					});
				</script>
				<div id="navi">
					<ul id="appsItemCategoryTag">
						<li class="appsItemCategoryTag_child mens"><a href="../client_html/1463951.html"
								class="mainHeaderNavColor">MENS</a>
							<ul class="appsItemCategoryTag_lowerchild">
                                
                            </ul>
						</li>
						<li class="appsItemCategoryTag_child ladies"><a href="../client_html/1463950.html"
								class="mainHeaderNavColor">LADIES</a>
							<ul class="appsItemCategoryTag_lowerchild"></ul>
						</li>
					</ul>
					<p class="sale"><a href="../client_html/1764275.html">SALE</a></p>
				</div>
				<!--/.navi-->
							...
							<li class="column">
								<div id="category-menu">
									...
									<div class="category-list">
										<ul id="appsItemCategoryTag">
											<!-- 大カテゴリのループ -->
											<li class="appsItemCategoryTag_child"><a href="../client_html/1803790.html">Weekly
													Ranking</a>
											</li>
											<!-- 大カテゴリのループ -->
											<li class="appsItemCategoryTag_child"><a href="../client_html/3803574.html">Restock
													items</a>
											</li>
											<!-- 大カテゴリのループ -->
											<li class="appsItemCategoryTag_child"><a href="../client_html/1991343.html">Category
													Best10</a>
											</li>
											<!-- 大カテゴリのループ -->
											<li class="appsItemCategoryTag_child"><a href="../client_html/1764275.html">Today
													10%OFF</a>
											</li>
											<!-- 大カテゴリのループ -->
											<li class="appsItemCategoryTag_child"><a href="../client_html/2614009.html">FAST</a>
											</li>
											<!-- 大カテゴリのループ -->
											<li class="appsItemCategoryTag_child"><a href="../client_html/1623874.html">Next HIT</a>
											</li>
											<!-- 大カテゴリのループ -->
											<li class="appsItemCategoryTag_child"><a href="../client_html/1612755.html">New
													Arrivals</a>
											</li>
											<!-- 大カテゴリのループ -->
											<li class="appsItemCategoryTag_child"><a href="../client_html/1463951.html">MENS</a>
											</li>
											<!-- 大カテゴリのループ -->
											<li class="appsItemCategoryTag_child"><a href="../client_html/1463950.html">LADIES</a>
											</li>
											<!-- 大カテゴリのループ -->
											<li class="appsItemCategoryTag_child"><a href="../client_html/1150353.html">Tops</a>
											</li>
											<!-- 大カテゴリのループ -->
											<li class="appsItemCategoryTag_child"><a href="../client_html/1150354.html">Outer</a>
											</li>
											<!-- 大カテゴリのループ -->
											<li class="appsItemCategoryTag_child"><a href="../client_html/1150355.html">Bottoms</a>
											</li>
											<!-- 大カテゴリのループ -->
											<li class="appsItemCategoryTag_child"><a href="../client_html/1150356.html">Set-up</a>
											</li>
											<!-- 大カテゴリのループ -->
											<li class="appsItemCategoryTag_child"><a href="../client_html/1459751.html">Dress</a>
											</li>
											<!-- 大カテゴリのループ -->
											<li class="appsItemCategoryTag_child"><a href="../client_html/1150357.html">Bag</a>
											</li>
											<!-- 大カテゴリのループ -->
											<li class="appsItemCategoryTag_child"><a href="../client_html/1991271.html">Shoes</a>
											</li>
											<!-- 大カテゴリのループ -->
											<li class="appsItemCategoryTag_child"><a href="../client_html/1150358.html">Accessory</a>
											</li>
											<!-- 大カテゴリのループ -->
											<li class="appsItemCategoryTag_child"><a href="../client_html/1991280.html">Other</a>
											</li>
											<!-- 大カテゴリのループ -->
											<li class="appsItemCategoryTag_child"><a href="../client_html/3406564.html">Room-wear</a>
											</li>
											<!-- 大カテゴリのループ -->
											<li class="appsItemCategoryTag_child"><a href="../client_html/1745897.html">~¥5,000</a>
											</li>
											<!-- 大カテゴリのループ -->
											<li class="appsItemCategoryTag_child"><a href="../client_html/1745898.html">¥5,000~</a>
											</li>
											<!-- 大カテゴリのループ -->
											<li class="appsItemCategoryTag_child"><a href="../client_html/1991260.html">FASHIONISTA ×
													BEEP</a>
											</li>
										</ul>
									</div>
							...
							<dd>
								...
								<div class="txt">登録したメールアドレスに誤りがあるか、 迷惑メールに入ってしまっている可能性がございます。<br>
									...
									<ul>
										...
										<li>BEEPメールアドレス：<a href="../client_html/maito:beepinfo@bordi.co.jp">beepinfo@bordi.co.jp</a>
										</li>
									</ul>
								</div>
							</dd>
	...
	<div class="container">
		...
		<section id="products">
			...
			<div id="categoryList">
				<!-- カテゴリ名をページの見出しとして表示 -->
				<h3 class="categoryTitle01" style="text-transform:uppercase">{{$category_parent->name}}</h3>
				<!-- 子カテゴリの一覧を表示 -->
				<ul>
        ...
        <script>
            $(document).ready(function() {
                let arr = [];
                    $.ajax(`http://laravel-training.local:81/api/v1/products?includes[]=product_details&filter_groups[0][filters][1][key]=category_id&filter_groups[0][filters][1][operator]=eq&filter_groups[0][filters][1][value]=<?php echo $id; ?>`, {
	...
	<p id="pageTop"><a href="../client_html/#">ページトップへ戻る</a></p>

	<footer id="mainFooter">
		<div class="logoBox">
			<ul>
				<li><a href=https://www.17kg.shop/" target="_blank"><img
							src="../client_html/img/shop/logo_17kg.png"
							alt="17kg"></a></li>
				<li class="udresser"><a href=https://www.udresser.shop/" target="_blank"><img
							src="../client_html/img/shop/logo_udresser.png"
							alt="udresser"></a></li>
				<li><a href=https://www.lilyboutique.tokyo/" target="_blank"><img
							src="../client_html/img/shop/logo_lily.png"
							alt="lily boutique"></a></li>
				<li><a href=https://www.belle-17kg.com/" target="_blank"><img
							src="../client_html/img/shop/logo_belle.png"
							alt="belle"></a></li>
				<li class="goodnight5tore"><a href=https://goodnight5tore.myshopify.com/" target="_blank"><img
							src="../client_html/img/shop/logo_goodnight5tore.png"
							alt="good night 5tore"></a></li>
			</ul>
		</div>
		...
		<ul class="txtList clearfix">
			...
			<li>
				<div id="i18" class="clearfix">
					<div class="lang">
						<form
							action="https://www.beepsheepshamp.com/i18n/i18n_user_languages/change_language?back=http%3A%2F%2Fwww.beepsheepshamp.com%2Fcategories%2F1150353"
							method="post" accept-charset="utf-8">
							<div style="display:none;"><input type="hidden" name="_method" value="POST" /><input
									type="hidden" name="data[_Token][key]"
									value="ec208cd5d280e7119114946c56937ca203f90d8b4d3c65621feb447ad9c59a0328f4ff1fb6591496da5d201601d43e6ef8d6aca6f9c38c295438a16bc7d9452b"
									id="Token2109755597" autocomplete="off" /></div><input type="hidden"
								name="data[UserLanguage][shop_id]" value="naughtyboy-base-shop"
								id="UserLanguageShopId" />
							<div class="input select required"><select name="data[UserLanguage][language_code]"
									class="x_i18nSelectBox" required="required">
									<option value="ja">日本語</option>
									<option value="en" selected="selected">English</option>
								</select></div>
							<div style="display:none;"><input type="hidden" name="data[_Token][fields]"
									value="458c5e42b2793d606c854b00194d215724cee125%3AUserLanguage.shop_id"
									id="TokenFields900246848" autocomplete="off" /><input type="hidden"
									name="data[_Token][unlocked]" value="" id="TokenUnlocked289542993"
					...
					<div class="currency">
						<form
							action="https://www.beepsheepshamp.com/i18n/i18n_user_currencies/change_currency?back=http%3A%2F%2Fwww.beepsheepshamp.com%2Fcategories%2F1150353"
							method="post" accept-charset="utf-8">
							<div style="display:none;"><input type="hidden" name="_method" value="POST" /><input
									type="hidden" name="data[_Token][key]"
									value="ec208cd5d280e7119114946c56937ca203f90d8b4d3c65621feb447ad9c59a0328f4ff1fb6591496da5d201601d43e6ef8d6aca6f9c38c295438a16bc7d9452b"
									id="Token1975954967" autocomplete="off" /></div><input type="hidden"
								name="data[UserCurrency][shop_id]" value="naughtyboy-base-shop"
								id="UserCurrencyShopId" />
							<div class="input select"><select name="data[UserCurrency][currency_code]"
									class="x_i18nSelectBox">
							...
							<div style="display:none;"><input type="hidden" name="data[_Token][fields]"
									value="a70de5ff2eae2d6f62afc3365141817c50e9969a%3AUserCurrency.shop_id"
									id="TokenFields451531701" autocomplete="off" /><input type="hidden"
									name="data[_Token][unlocked]" value="" id="TokenUnlocked1514980572"
									autocomplete="off" /></div>
						</form>
					</div>
				</div>
			...
			<li class="boxRight">
				<div class="socialBtnList clearfix">
					<div class="fb sns">
						<div class="fb-like" data-href="https://www.beepsheepshamp.com//" data-send="false"
							data-layout="button_count" data-width="200" data-show-faces="false"></div>
					</div>
					<div class="tw sns">
						<a href="http://twitter.com/share" class="twitter-share-button"
							data-url="https://www.beepsheepshamp.com/" data-lang="ja"
							data-text="BEEP | 韓国メンズファッション通販サイト" data-hashtags="" data-via="beep__official">Tweet!</a>
					</div>
				</div>
			</li>
		</ul>
		...
		<div class="iconBox">
			<ul class="snsBox">
				<li class="twitter"><a href=https://twitter.com/beep__official" target="_blank"><img
							src="../client_html/img/shop/icon_twitter.png"></a></li>
				<li class="instagram"><a href="../client_html/http://instagram.com/beep_ss" target="_blank"><img
							src="../client_html/img/shop/icon_instagram.png"></a>
				</li>
				<li class="line"><a href="../client_html/http://nav.cx/4HjFIy4" target="_blank"><img
							src="../client_html/img/shop/icon_line.png"></a></li>
			</ul>
		</div>
