...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../client_html/asset/shop/BASEshop-fa1704d831a85975bac460e5.css?1640247167" />
    <meta charset="utf-8">
    <meta name="copyright" content="BASE" />
    <title>BEEP | 韓国メンズファッション通販サイト</title>
    <link rel='icon' type='image/png' href='img/203e1caf5c843bba012315ffba1ad970.png' />
    <link rel='apple-touch-icon' sizes='180x180' href='img/203e1caf5c843bba012315ffba1ad970.png' />
    <link rel='apple-touch-icon-precomposed' href='img/203e1caf5c843bba012315ffba1ad970.png' />

    <script src='../client_html/js/jquery-1.8.2.min.js'></script>

    <meta name="BASE-Theme-Name" content="shop">
    <meta name="BASE-Theme-Version" content="1">

    <script src="../client_html/js/a8sales.js"></script>
    <script src="../client_html/js/a8crossDomain.js"></script>


    <meta http-equiv="X-UA-Compatible" content="IE=8 ; IE=9" />
    <meta name="description"
        content="オシャレ好きな人のための韓国メンズファッション通販サイト『BEEP（ビープ）』は個性的なセットアップから大きいサイズのアイテムまで1,000商品以上の商品を幅広く取り揃えており、安い価格で提供しています。" />
    <meta name="keywords" content="韓国メンズファッション,セットアップ,大きいサイズ" />
    <meta property="fb:app_id" content="350947278320210" />
    <meta property="og:description"
        content="オシャレ好きな人のための韓国メンズファッション通販サイト『BEEP（ビープ）』は個性的なセットアップから大きいサイズのアイテムまで1,000商品以上の商品を幅広く取り揃えており、安い価格で提供しています。" />
    <meta property="og:title" content="BEEP | 韓国メンズファッション通販サイト " />
    <meta property="og:image"
        content="https://baseec-img-mng.akamaized.net/images/user/logo/f5904431f43d44d07a7a21a716c96da2.png?imformat=generic&q=90&im=Resize,width=1200,height=1200,aspect=fit,type=normal;Crop,width=1200,height=1200,gravity=Center,allowExpansion" />
    <meta property="og:url" content="https://www.beepsheepshamp.com/" />
    <meta property="og:site_name" content="BEEP | 韓国メンズファッション通販サイト " />
    <meta property="og:type" content="website" />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:site" content="@beep__official" />
    <meta name="twitter:url" content="https://www.beepsheepshamp.com/" />
    <meta name="twitter:title" content="BEEP | 韓国メンズファッション通販サイト " />
    ...
    <link rel="stylesheet" href="../client_html/css/common.css">
    <link rel="stylesheet" href="../client_html/css/shop_00.css">

    <link rel="stylesheet" type="text/css" href="../client_html/css/slick.css">
    <link rel="stylesheet" type="text/css" href="../client_html/css/slick-theme.css">

    <link rel="stylesheet" type="text/css" href="../client_html/css/tohu_style.css">

    <link rel="stylesheet" type="text/css" href="../client_html/css/modaal.css">

    <script src="../client_html/js/jquery.bottom-1.0.js"></script>
    <script src="../client_html/js/change_statuse11a.js?1639973837024"></script>
    <script src="../client_html/js/common.js"></script>

    <script src="../client_html/js/modaal.min.js"></script>

    <script src="../client_html/js/jquery.cookie.js"></script>
    <script src="../client_html/js/jquery.layerBoard.js"></script>
    ...
    padding: 0 0 7px;*/
        ...
        .tempTop .item-detail .priceSale {
            font-size: 10px;
            padding: 0 0 0 5px;
        }

        .tempTop .descri .priceSale {
            font-size: 14px;
            padding: 0 0 0 5px;
        }
        ...
        #searchBox button {
            background: #777 url("img/shop/search.png") no-repeat center center;
            line-height: 20px;
            border-style: none;
            float: left;
            padding: 12px 14px;
    ...
    <script>
        ...
        gtag('js', new Date());
        gtag('set', 'linker', {
            'domains': ['www.beepsheepshamp.com', 'c.thebase.in']
        });
        gtag('config', 'UA-122256244-1');
        gtag('config', 'AW-998354622');
    ...
    <script>
        ...
        fbq('init', '883187149238792', {}, {
            agent: 'plthebase'
        });
        fbq('trackSingle', '883187149238792', 'PageView');

        data = null;

        fbq('init', '225009265175275', {}, {
            agent: 'plthebase'
        });
        fbq('trackSingle', '225009265175275', 'PageView');
        ...
        if (data) {
            (function (data) {
                window.addEventListener('load', function () {
                    $.ajax({
                        type: 'POST',
                        url: "https://www.beepsheepshamp.com/facebook/conversion/",
                        dataType: 'json',
                        data: data,
    ...
    <script type="text/javascript">
        ...
        window.NREUM || (NREUM = {}), __nr_require = function (t, e, n) {
            ...
            1: [function (t, e, n) {
                ...
                try {
                    o = localStorage.getItem("__nr_flags").split(","), console && "function" ==
                        typeof console
                        .log && (c.console = !0, o.indexOf("dev") !== -1 && (c.dev = !0), o.indexOf(
                            "nr_dev") !== -1 && (c.nrDev = !0))
                } catch (s) {}
                c.nrDev && i.on("internal-error", function (t) {
                    ...
                    r(n.stack)
                }), c.dev && (r("NR AGENT IN DEVELOPMENT MODE"), r("flags: " + a(c, function (t,
                e) {
                    return t
                }).join(", ")))
            }, {}],
            2: [function (t, e, n) {
                ...
                try {
                    ...
                    "stack" in h && (t(13), t(12), "addEventListener" in window && t(6), s
                        .xhrWrappable && t(
                            14), d = !0)
                }
            ...
            4: [function (t, e, n) {
                ...
                if (w[v] && y.xhrWrappable) {
                    ...
                    var T, L = 0;
                    S.on(f, r), b.on(p, r), M.on(p, r), S.on(d, o), b.on(l, o), M.on(l, o), S.buffer([f,
                            d,
                            "xhr-done", "xhr-resolved"
                        ]), R.buffer([f]), O.buffer(["setTimeout" + s, "clearTimeout" + c, f]), P
                        .buffer([f,
                            "new-xhr", "send-xhr" + c
                        ]), N.buffer([m + c, m + "-done", m + u + c, m + u + s]), E.buffer(["newURL"]),
                        x
                        .buffer([f]), b.buffer(["propagate", p, l, "executor-err", "resolve" + c]), C
                        .buffer([
                            f, "no-" + f
                        ]), M.buffer(["new-jsonp", "cb-start", "jsonp-error", "jsonp-end"]), a(P,
                            "send-xhr" +
                            c), a(S, "xhr-resolved"), a(S, "xhr-done"), a(N, m + c), a(N, m + "-done"),
                        a(M,
                            "new-jsonp"), a(M, "jsonp-end"), a(M, "cb-start"), E.on("pushState-end", i),
                        E.on(
                            "replaceState-end", i), w[v]("hashchange", i, !0), w[v]("load", i, !0), w[v]
                        (
                            "popstate",
                            function () {
                                i(0, L > 1)
            ...
            5: [function (t, e, n) {
                ...
                if (window.performance && window.performance.timing && window.performance
                    ...
                    o.on(m, function (t, e) {
                        ...
                        i("bstHist", [location.pathname + location.hash, this.startPath, this
                            .time
                        ])
                    }), u in window.performance && (window.performance["c" + s] ? window
                        .performance[u](f,
                            function (t) {
            ...
            9: [function (t, e, n) {
                    ...
                    if (r) {
                        ...
                        if (o) {
                            ...
                            if (a) {
                                ...
                                if (d) {
                                    var p = {};
                                    u.inPlace(f.parent, [f.key], "cb-", p), t.addEventListener("load",
                                            e, !1),
                                        t.addEventListener("error", n, !1), s.emit("new-jsonp", [t.src],
                                            p)
                                }
                            }
                        }
                ...
                if (e.exports = s, o()) {
                    ...
                    Node && Node.prototype && Node.prototype.appendChild ? u.inPlace(Node.prototype, l,
                            ...
                            HTMLHeadElement
                            .prototype, l, "dom-"), u.inPlace(HTMLBodyElement.prototype, l, "dom-")), s
                        .on(
                            "dom-start",
                            function (t) {
                                r(t[0])
                ...
                e.exports = i, u && (window.Promise = r, ["all", "race"].forEach(function (t) {
                    ...
                    return function () {
                        var e = this,
                            ...
                            r = a(e);
                        r.promise = e, n[0] = c(n[0], "cb-", r, null, !1), n[1] = c(n[
                            1],
                            "cb-", r, null, !1);
                        var s = t.apply(this, n);
                        return r.nextPromise = s, i.emit("propagate", [e, !0], s, !1, !
                            1), s
                    }
                }), i.on("executor-start", function (t) {
                    t[0] = c(t[0], "resolve-", this, null, !1), t[1] = c(t[1], "resolve-",
                        this,
                        null, !1)
            ...
            13: [function (t, e, n) {
                ...
                var i = t("ee").get("timer"),
                    ...
                    f = "-start",
                    d = "-";
                e.exports = i, a.inPlace(window, [c, "setImmediate"], c + d), a.inPlace(window, [s], s +
                        d), a
                    .inPlace(window, [u, "clearImmediate"], u + d), i.on(s + f, r), i.on(c + f, o)
            }, {}],
            14: [function (t, e, n) {
                function r(t, e) {
                ...
                if (s(l, x), x.prototype = l.prototype, d.inPlace(x.prototype, ["open", "send"],
                        "-xhr-", c),
            ...
            16: [function (t, e, n) {
                function r(t) {
                    ...
                    if (!this.ended) {
                        ...
                        e.aborted || (n.duration = a.now() - this.startTime, this.loadCaptureCalled ||
                            4 !== t
                            .readyState ? null == e.status && (e.status = 0) : i(this, t), n
                            .cbTime = this
                            .cbTime, f.emit("xhr-done", [t], t), c("xhr", [e, n, this.startTime]))
                    }
                }
                ...
                function o(t, e) {
                    var n = s(e),
                        r = t.params;
                    r.host = n.hostname + ":" + n.port, r.pathname = n.pathname, t.parsedOrigin = s(e),
                        t
                    ...
                    a.features.xhr = !0, t(14), t(7), f.on("new-xhr", function (t) {
                        ...
                        if (n) {
                            ...
                            n.newrelicHeader && (e.setRequestHeader("newrelic", n
                                ...
                                .traceContextStateHeader && e.setRequestHeader("tracestate",
                                    n
                        ...
                        this.startTime = a.now(), this.listener = function (t) {
                            try {
                                "abort" !== t.type || o.loadCaptureCalled || (o.params
                                        .aborted = !
                                        0), ("load" !== t.type || o.called === o.totalCbs &&
                                        (o
                                            .onloadCalled || "function" != typeof e.onload)
                                        ) && o.end(
                                        e)
                            } catch (n) {
                                try {
                        ...
                        e instanceof w && "load" === t[0] && f.emit("xhr-load-added", [t[1], t[
                            2]], e)
                    }), f.on("removeEventListener-end", function (t, e) {
                        e instanceof w && "load" === t[0] && f.emit("xhr-load-removed", [t[1],
                                t[2]
                            ],
                            e)
                        ...
                        e instanceof w && ("onload" === n && (this.onload = !0), ("load" === (t[
                                0] &&
                            t[0].type) || this.onload) && (this.xhrCbStart = a.now()))
                        ...
                        function e(t, e) {
                            ...
                            return e.newrelicHeader && (t.set("newrelic", e.newrelicHeader),
                                    n = !0),
                                e.traceContextParentHeader && (t.set("traceparent", e
                                        .traceContextParentHeader), e.traceContextStateHeader &&
                                    t
                        ...
                        "string" == typeof t[0] ? n = t[0] : t[0] && t[0].url ? n = t[0].url :
                            window
                            .URL && t[0] && t[0] instanceof URL && (n = t[0].href), n && (this
                                .parsedOrigin = s(n), this.sameOrigin = this.parsedOrigin
                                .sameOrigin);
            ...
            17: [function (t, e, n) {
                ...
                e.exports = function (t) {
                    ...
                    var i = e.href.split("://");
                    !o.port && i[1] && (o.port = i[1].split("index.html")[0].split("@").pop().split(
                            ":")[
                            1]), o.port && "0" !== o.port || (o.port = "https" === i[0] ? "443" :
                            "80"), o
                    ...
                    return o.sameOrigin = a && (!e.hostname || c), "/" === o.pathname && (r[t] = o),
                        o
                }
            }, {}],
            18: [function (t, e, n) {
                function r(t, e) {
                    ...
                    return "json" === n && null !== e ? e : "arraybuffer" === n || "blob" === n ||
                        "json" ===
                        n ? o(t.response) : "text" === n || "" === n || void 0 === n ? o(t
                        .responseText) :
                        void 0
                }
                var o = t(20);
            ...
            19: [function (t, e, n) {
                ...
                function o(t, e, n) {
                    return function () {
                        return i(t, [u.now()].concat(c(arguments)), e ? null : this, n), e ?
                            void 0 : this
                    }
                }
                var i = t("handle"),
                ...
                var h = r.prototype = {
                    createTracer: function (t, e) {
                        ...
                        return i(l + "tracer", [u.now(), t, n], r),
                            function () {
                                if (s.emit((o ? "" : "no-") + "fn-start", [u.now(), r, o], n),
                                    o)
                                    try {
            ...
            23: [function (t, e, n) {
                function r(t, e) {
                    ...
                    n.forEach(function (t) {
                        "first-paint" === t.name ? d("timing", ["fp", Math.floor(t
                            .startTime)]) :
                            "first-contentful-paint" === t.name && d("timing", ["fcp", Math
                                .floor(t
                                    .startTime)
                            ])
                    })
                ...
                function a(t) {
                    if (t instanceof h && !v) {
                        ...
                        e <= p.now() ? n.fid = p.now() - e : e > p.offset && e <= Date.now() ? (e -= p
                            .offset,
                            n.fid = p.now() - e) : e = p.now(), v = !0, d("timing", ["fi", e, n])
                    }
                }
            ...
            24: [function (t, e, n) {
                function r() {
                    ...
                    for (var o, i = "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx", a = "", c = 0; c < i
                        .length; c++)
                        o = i[c], "x" === o ? a += t().toString(16) : "y" === o ? (o = 3 & t() | 8, a +=
                            o
                            .toString(16)) : a += o;
                    return a
                }
            ...
            25: [function (t, e, n) {
                ...
                if (navigator.userAgent) {
                    var c = navigator.userAgent,
                        s = c.match(a);
                    s && c.indexOf("Chrome") === -1 && c.indexOf("Chromium") === -1 && (o = "Safari",
                        i = s[
                            1])
                }
                e.exports = {
                ...
                function o(t) {
                    ...
                    function n(n, r, o, i, a) {
                        if (a !== !1 && (a = !0), !l.aborted || i) {
                            t && a && t(n, r, o);
                            for (var c = e(o), s = m(n), u = s.length, f = 0; f < u; f++) s[f].apply(c,
                                r);
                            var p = d[y[n]];
            ...
            loader: [function (t, e, n) {
                ...
                t(19), t(23), p[l] ? (p[l]("DOMContentLoaded", i, !1), d[l]("load", r, !1)) : (p[h](
                    "onreadystatechange", o), d[h]("onload", r)), c("mark", ["firstbyte", a
                    .getLastTimestamp()
                ], null, "api");
                var b = 0
            }, {}],
            "wrap-function": [function (t, e, n) {
                function r(t, e) {
                    ...
                    function r(t, e, r, o, i) {
                        ...
                        for (u = 0; u < e.length; u++) s = e[u], c = t[s], a(c) || (t[s] = n(c, f ? s +
                            r : r,
                            o, s, i))
                    }
        ...
        NREUM.loader_config = {
            ...
            trustKey: "2804831",
            agentID: "663072695",
            licenseKey: "NRJS-4c41e18b2dabf750af0",
            applicationID: "663072695"
        };
        NREUM.info = {
            beacon: "bam.nr-data.net",
            errorBeacon: "bam.nr-data.net",
...
<body class="tempTop template tempDetail" cz-shortcut-listen="true">
    <img id="tracimg" style="display: none;"
        src="https://track.thebase.in/index.php?dc_action=access/index&amp;type=2&amp;view_shop_id=naughtyboy-base-shop&amp;url=http%3A%2F%2Fwww.beepsheepshamp.com%2Fitems%2F57590309&amp;time=1643161431">

    <script type="text/javascript">
        var url =
            "https\u003a\u002f\u002ftrack.thebase.in\u002findex.php\u003fdc\u005faction\u003daccess\u002findex\u0026type\u003d2\u0026view\u005fshop\u005fid\u003dnaughtyboy-base-shop\u0026url\u003dhttp\u00253A\u00252F\u00252Fwww.beepsheepshamp.com\u00252Fitems\u00252F57590309\u0026time\u003d1643161431";
    ...
    <link rel="stylesheet" type="text/css" href="../client_html//css/colorbox.css">
    <link rel="stylesheet" href="../client_html//css/bootstrap.min.css">
    <link rel="stylesheet" href="../client_html//css/bootstrap-select.min.css">
    ...
    <div id="layer_board_area">
        ...
        <p class="layer_board_close"><span></span></p>
        <div class="layer_board">
            <p><a href="https://apps.apple.com/jp/app/beep-sheep-shamp/id1559411993" target="_blank"><img
                        src="https://base-ec2.akamaized.net/images/shop_front/naughtyboy-base-shop/4e57e958c69587ba6806fac02ddb362b.PNG"
                        class="pc"><img
                        src="https://base-ec2.akamaized.net/images/shop_front/naughtyboy-base-shop/e2d0de3c41568de8731e5ff8a496abed.PNG"
                        class="sp"></a></p>
        </div>
    </div>
    <!-- //layer_board -->
    ...
    <div id="shoulder">
        <div id="shoulderCol">
            <p class="txt"><img src="https://basefile.akamaized.net/tohu-buyshop-jp/5e9f3447576ef/shoulder_txt.png"></p>
                    ...
                    <ul class="clearfix">
                        <li class="base" style="visibility: hidden;"><a target="_blank" rel="nofollow"
                                href="https://thebase.in?from=naughtyboy-base-shop&amp;p=shop"><img
                                    src="/img/shop/base.png" alt="ネットショップを開設するならBASE" title="BASE" height="30"></a></li>
                        <li class="cart"><a href="https://www.beepsheepshamp.com/cart/add/naughtyboy-base-shop"><img
                                    src="/img/shop/cart.png" alt="shopping cart" height="30"></a></li>
                    </ul>
                </div>
                <p class="searchMenu"><a class="inline fade" href="../client_html/#searchBox"
                        data-modaal-scope="modaal_164316142834631071e388c0df"><img
                            src="https://basefile.akamaized.net/tohu-buyshop-jp/5e9f34a09596a/search.png"></a></p>
            </div>
            ...
            <div style="display:none">
                <div id="searchBox" class="modal" data-modaal-scope="modaal_16431614283356ab00f04ef31">
                    <form action="//www.beepsheepshamp.com/search" method="get" class="search_container">
    ...
    <!--========================================-->
    <div id="headWrapper">
        <header id="mainHeader" style="top: -140px;" class="">
            <div id="headCol">
                ...
                <h1><a href="https://www.beepsheepshamp.com" id="logo"><img class="logoImage"
                            src="https://base-ec2if.akamaized.net/w=2048,a=0,q=90,u=0/images/user/logo/f5904431f43d44d07a7a21a716c96da2.png"
                            alt="BEEP | 韓国メンズファッション通販サイト"></a></h1>
                <script type="text/javascript">
                    $(function () {
                        $("header #headCol #navi ul li.mens a").load(
                            "https://www.beepsheepshamp.com/categories/1463951 h3.categoryTitle01");
                        $("header #headCol #navi ul li.mens ul").load(
                            "https://www.beepsheepshamp.com/categories/1463951 #categoryList ul li");
                        $("header #headCol #navi ul li.ladies a").load(
                            "https://www.beepsheepshamp.com/categories/1463950 h3.categoryTitle01");
                        $("header #headCol #navi ul li.ladies ul").load(
                            "https://www.beepsheepshamp.com/categories/1463950 #categoryList ul li");
                    });

                </script>
                <div id="navi">
                    <ul id="appsItemCategoryTag">
                        <li class="appsItemCategoryTag_child mens"><a
                                href="https://www.beepsheepshamp.com/categories/1463951" class="mainHeaderNavColor">
                                <h3 class="categoryTitle01">MENS</h3>
                            </a>
                            <ul class="appsItemCategoryTag_lowerchild">
                                <li>tops</li>
                                <li><a href="https://www.beepsheepshamp.com/categories/1463968">outer</a></li>
                                <li><a href="https://www.beepsheepshamp.com/categories/1463969">bottoms</a></li>
                                <li><a href="https://www.beepsheepshamp.com/categories/1463970">set-up</a></li>
                                <li><a href="https://www.beepsheepshamp.com/categories/1463972">bag</a></li>
                                <li><a href="https://www.beepsheepshamp.com/categories/1992198">shoes</a></li>
                                <li><a href="https://www.beepsheepshamp.com/categories/1463971">goods</a></li>
                                <li><a href="https://www.beepsheepshamp.com/categories/1691390">other</a></li>
                            </ul>
                        </li>
                        <li class="appsItemCategoryTag_child ladies"><a
                                href="https://www.beepsheepshamp.com/categories/1463950" class="mainHeaderNavColor">
                                <h3 class="categoryTitle01">LADIES</h3>
                            </a>
                            <ul class="appsItemCategoryTag_lowerchild">
                                <li><a href="https://www.beepsheepshamp.com/categories/1463955">tops</a></li>
                                <li><a href="https://www.beepsheepshamp.com/categories/1463956">outer</a></li>
                                <li><a href="https://www.beepsheepshamp.com/categories/1463958">bottoms</a></li>
                                <li><a href="https://www.beepsheepshamp.com/categories/1463959">set-up</a></li>
                                <li><a href="https://www.beepsheepshamp.com/categories/1463963">dress</a></li>
                                <li><a href="https://www.beepsheepshamp.com/categories/1463966">bag</a></li>
                                <li><a href="https://www.beepsheepshamp.com/categories/1463964">goods</a></li>
                                <li><a href="https://www.beepsheepshamp.com/categories/1992199">shoes</a></li>
                                <li><a href="https://www.beepsheepshamp.com/categories/1691393">other</a></li>
                            </ul>
                        </li>
                    </ul>
                    <p class="sale"><a href="https://www.beepsheepshamp.com/categories/1764275">SALE</a></p>
                </div>
                <!--/.navi-->
                    ...
                    <div id="gnaviCol" class="clearfix">
                        <ul class="row">
                            <li class="column"><a class="mainHeaderNavColor"
                                    href="https://www.beepsheepshamp.com">HOME</a></li>
                            <li class="column"><a class="mainHeaderNavColor"
                                    href="https://www.beepsheepshamp.com/about">CAUTION</a></li>
                                    ...
                                    <div class="category-list">
                                        <ul id="appsItemCategoryTag">
                                            ...
                                            <li class="appsItemCategoryTag_child"><a
                                                    href="https://www.beepsheepshamp.com/categories/1803790">Weekly
                                                    Ranking</a>
                                            </li>
                                            <!-- 大カテゴリのループ -->
                                            <li class="appsItemCategoryTag_child"><a
                                                    href="https://www.beepsheepshamp.com/categories/3803574">Restock
                                                    items</a>
                                            </li>
                                            <!-- 大カテゴリのループ -->
                                            <li class="appsItemCategoryTag_child"><a
                                                    href="https://www.beepsheepshamp.com/categories/1991343">Category
                                                    Best10</a>
                                            </li>
                                            <!-- 大カテゴリのループ -->
                                            <li class="appsItemCategoryTag_child"><a
                                                    href="https://www.beepsheepshamp.com/categories/1764275">Today
                                                    10%OFF</a>
                                            </li>
                                            <!-- 大カテゴリのループ -->
                                            <li class="appsItemCategoryTag_child"><a
                                                    href="https://www.beepsheepshamp.com/categories/2614009">FAST</a>
                                            </li>
                                            <!-- 大カテゴリのループ -->
                                            <li class="appsItemCategoryTag_child"><a
                                                    href="https://www.beepsheepshamp.com/categories/1623874">Next
                                                    HIT</a>
                                            </li>
                                            <!-- 大カテゴリのループ -->
                                            <li class="appsItemCategoryTag_child"><a
                                                    href="https://www.beepsheepshamp.com/categories/1612755">New
                                                    Arrivals</a>
                                            </li>
                                            <!-- 大カテゴリのループ -->
                                            <li class="appsItemCategoryTag_child"><a
                                                    href="https://www.beepsheepshamp.com/categories/1463951">MENS</a>
                                            </li>
                                            <!-- 大カテゴリのループ -->
                                            <li class="appsItemCategoryTag_child"><a
                                                    href="https://www.beepsheepshamp.com/categories/1463950">LADIES</a>
                                            </li>
                                            <!-- 大カテゴリのループ -->
                                            <li class="appsItemCategoryTag_child"><a
                                                    href="https://www.beepsheepshamp.com/categories/1150353">Tops</a>
                                            </li>
                                            <!-- 大カテゴリのループ -->
                                            <li class="appsItemCategoryTag_child"><a
                                                    href="https://www.beepsheepshamp.com/categories/1150354">Outer</a>
                                            </li>
                                            <!-- 大カテゴリのループ -->
                                            <li class="appsItemCategoryTag_child"><a
                                                    href="https://www.beepsheepshamp.com/categories/1150355">Bottoms</a>
                                            </li>
                                            <!-- 大カテゴリのループ -->
                                            <li class="appsItemCategoryTag_child"><a
                                                    href="https://www.beepsheepshamp.com/categories/1150356">Set-up</a>
                                            </li>
                                            <!-- 大カテゴリのループ -->
                                            <li class="appsItemCategoryTag_child"><a
                                                    href="https://www.beepsheepshamp.com/categories/1459751">Dress</a>
                                            </li>
                                            <!-- 大カテゴリのループ -->
                                            <li class="appsItemCategoryTag_child"><a
                                                    href="https://www.beepsheepshamp.com/categories/1150357">Bag</a>
                                            </li>
                                            <!-- 大カテゴリのループ -->
                                            <li class="appsItemCategoryTag_child"><a
                                                    href="https://www.beepsheepshamp.com/categories/1991271">Shoes</a>
                                            </li>
                                            <!-- 大カテゴリのループ -->
                                            <li class="appsItemCategoryTag_child"><a
                                                    href="https://www.beepsheepshamp.com/categories/1150358">Accessory</a>
                                            </li>
                                            <!-- 大カテゴリのループ -->
                                            <li class="appsItemCategoryTag_child"><a
                                                    href="https://www.beepsheepshamp.com/categories/1991280">Other</a>
                                            </li>
                                            <!-- 大カテゴリのループ -->
                                            <li class="appsItemCategoryTag_child"><a
                                                    href="https://www.beepsheepshamp.com/categories/3406564">Room-wear</a>
                                            </li>
                                            <!-- 大カテゴリのループ -->
                                            <li class="appsItemCategoryTag_child"><a
                                                    href="https://www.beepsheepshamp.com/categories/1745897">~¥5,000</a>
                                            </li>
                                            <!-- 大カテゴリのループ -->
                                            <li class="appsItemCategoryTag_child"><a
                                                    href="https://www.beepsheepshamp.com/categories/1745898">¥5,000~</a>
                                            </li>
                                            <!-- 大カテゴリのループ -->
                                            <li class="appsItemCategoryTag_child"><a
                                                    href="https://www.beepsheepshamp.com/categories/1991260">FASHIONISTA
                                                    × BEEP</a>
                                            </li>
                                        </ul>
                                    </div>
                            ...
                            <li class="column"><a class="mainHeaderNavColor inline" href="../client_html/#Faq_content"
                                    data-modaal-scope="modaal_164316142834784647bbfa68ea">Q&amp;A</a></li>
                            <li class="column"><a class="mainHeaderNavColor"
                                    href="https://www.beepsheepshamp.com/blog">BLOG</a></li>
                            <li class="column"><a class="mainHeaderNavColor"
                    ...
                    <dl>
                        ...
                        <dd>
                            ...
                            <div class="txt">登録したメールアドレスに誤りがあるか、 迷惑メールに入ってしまっている可能性がございます。<br>
                                お手数ですが一度、ご確認お願いします。
                                <ul>
                                    <li>BASEメールアドレス：<a href="../client_html/maito:noreply@thebase.in">noreply@thebase.in</a></li>
                                    <li>BEEPメールアドレス：<a href="../client_html/maito:beepinfo@bordi.co.jp">beepinfo@bordi.co.jp</a></li>
                                </ul>
                            </div>
                        </dd>
                        <dt>
    ...
    <div style="display:none">
        <div id="Shippng_content" class="modal">
            <div id="shippngBox">
                <h2 class="ttl"><span>ショップの注意事項</span></h2>
                <h2>
                    <div class="txt">
                        ...
                        <dl>
                            <dl>
                                ※仕入先休業のお知らせ※
                                <br>
                                【 2022/1/21（金）〜2022/2/7（月）】
                                仕入先休業のため、発注/発送業務・お取り寄せ業務がお休みとなります。ご購入の際は余裕をもってお早めにお願いいたします。　　<dl>
                                    ※上記の期間にご注文いただいた場合、発送が通常の配送期間よりも大幅に遅れることが予想されます。（上記期間前後のご注文についても、影響を受ける可能性がございます）
                                    <dl>※ご注文からお届けまでは、1ヶ月程度（※土日祝日を除く営業日基準）を予定しております。
                                        <br>また、上記期間のご注文に関しましてご注文確定後のキャンセルはお受けできませんので予めご了承ください。<p></p>
                                        <br>少しでも早くお届けできるよう努めてまいりますが、通常時に比べ欠品や発送遅延が予想されます。ご迷惑をおかけしますが、何卒ご理解いただけますと幸いです。
                                        <p></p>
                                        <dl>
                                            <dl>
                                                <dt>①発着期間について</dt>
                                                <dd>
                                                    ...
                                                    <p>システム上、BASEより発送完了メールが届きますが、実際には発送手配は完了しておりませんのでご注意ください。</p>
                                                    <p>送料は一律700円です。<br>
                                                ...
                                                <dd>
                                                    <p>弊社へのお問い合わせは、メールでご連絡をお願いいたします。
                                                        <br>お問い合わせメールには土日祝祭日を除き3営業日以内に返信致します。<a
                                                            href="../client_html/mailto:beepinfo@bordi.co.jp">beepinfo@bordi.co.jp</a><br>
                                            ...
                                            <div class="notesBox">
                                                ...
                                                <ul>
                                                    ...
                                                    <li>３）発注が完了いたしましたご注文のカラー変更、サイズ変更はお受けしておりません。<br>
                                                        <br>
                                                        <ul class="notes">
                                                            <li>・サイズ変更、カラー、イメージが違う、実寸が違うなどのお客様都合での返品・交換は一切お受けしておりません。
                                                            </li>
                ...
                <div class="kakaku">
                    <div class="bx-wrapper" style="max-width: 100%;">
                        <div class="bx-viewport"
                            style="width: 100%; overflow: hidden; position: relative; height: 475px;">
                            <ul class="bxslider" style="width: auto; position: relative;">
                                @foreach($data->product_details()->get() as $product_detail)
                                <li
                                    style="float: none; list-style: none; position: absolute; width: 475px; z-index: 50; display: list-item;">
                                    <div class="img_box">
                                        <a href="https://baseec-img-mng.akamaized.net/images/item/origin/b4aa4e79bf5c3e0dc10ece101ba54636.jpg?imformat=generic"
                                            class="ajax btn grn save cboxElement" rel="group">
                                            <img src="../images/uploads/{{$product_detail->image}}"
                                                alt="" title="">
                                        </a>
                                    </div>
                                </li>
                    ...
                    <div id="bx-pager">
                        @foreach($data->product_details()->get() as $product_detail)
                        <a data-slide-index="0" href="../client_html/" class="">
                            <div class="small_img_box">
                                <img src="../images/uploads/{{$product_detail->image}}"
                                    alt="ゴシックロゴニット #BL9720" title="" id="img_large">
                            </div>
                        </a>
                       @endforeach
                    </div>
                ...
                <section class="row">
                    <div class="descri">
                        <div class="product">
                            ...
                            <div class="itemAttention clearfix price_value" itemprop="offers" itemscope=""
                        ...
                        <script>
                            $(document).ready(function() {
                                ...
                                let quantity = 1;
                                    $.ajax(`/api/v1/product_details?filter_groups[0][filters][1][key]=id&filter_groups[0][filters][1][operator]=eq&filter_groups[0][filters][1][value]=${value}`, {
                                        type: 'GET',  // http method
                                        dataType: 'json', 
                                        data: { myData: 'This is my data.' },  // data to submit
                                        success: function (data, status, xhr) {
                                            let html = ""
                                            arr = data.data.product_details;
                                            arr.forEach(obj => {
                                                if(obj.quantity < 1){
                                                    $('.quantity_value').html('')
                                            ...
                                            $('.price_value').append(html);
                                        },
                                        error: function (jqXhr, textStatus, errorMessage) {
                                            $('.price_value').append('Error: ' + errorMessage);
                                            }
                                        ...
                                        $('#valiationSelect').on('change',function(){
                                            ...
                                            let arr1 = [];
                                            $('.price_value').html("")
                                            $.ajax(`/api/v1/product_details?filter_groups[0][filters][1][key]=id&filter_groups[0][filters][1][operator]=eq&filter_groups[0][filters][1][value]=${id}`, {
                                                type: 'GET',  // http method
                                                dataType: 'json', 
                                                data: { myData: 'This is my data.' },  // data to submit
                                                success: function (data, status, xhr) {
                                                    let html = ""
                                                    arr1 = data.data.product_details;
                                                    arr1.forEach(obj => {
                                                        html += `<p class="price">¥${obj.price}</p>`
                                                        if(obj.quantity < 1){
                                                    $('.button_add').html(`<button type="submit" class="purchaseButton__btn purchaseButton__btn--outOfStock purchaseButton__btn--requestRestockMail x_restockMailNotificationModalOpen" disabled>Request restock notification</button>`)
                    ...
                    <form id="purchase_form" class="x_purchaseForm" name="menu" action="{{route('add-cart')}}" method="post" data-purchase-form="" data-disabled="true">
                        ...
                        <div id="itemSelect">
                                    ...
                                    <select name="order_detail[product_detail_id]" id="valiationSelect" class="product_detail_id" data-display-stock="0">
                                        ...
                                        <option value="{{$product_detail->id}}" data-stock="0">
                                            @foreach($attributes as $attribute)
                                                @foreach($product_detail->attribute_products()->get() as $attribute_product)
                                                    @if($attribute->id == $attribute_product->attribute_id)
                                                    {{$attribute->name}} : {{$attribute_product->value}}<br>
                                                    @endif
                                                @endforeach
                                            @endforeach
                                        </option>  
                            ...
                            <div id="variationSelectWrap" class="purchaseElement quantity_value" data-target-version="v2">
                        ...
                        <script>
                            if (!document.querySelector('form[data-purchase-form]')) {
                                $('#valiationSelect').on('change', function () {
                                    $('#amountSelectWrap  .amountSelect').css('display', 'none').prop(
                                        'disabled', true);
                                    $('#amountSelectWrap  .amountSelect:eq(' + $(this).find(':selected').attr(
                                        'data-index') + ')').css('display', '').prop('disabled', false);
                                });
                            }
                                ...
                                elements.forEach(el => {
                                    ...
                                    if (!form) {
                                        ...
                                        $itemSelect.find('#valiationSelect').on('change', function () {
                                            $itemSelect.find('#amountSelectWrap  .amountSelect')
                                                .css('display', 'none').prop('disabled', true);
                                            $itemSelect.find(
                                                    '#amountSelectWrap  .amountSelect:eq(' + $(this)
                                                    .find(':selected').attr('data-index') + ')')
                                                .css('display', '').prop('disabled', false);
                                        });
                                    } else {
                                        ...
                                        form.querySelectorAll('#valiationSelect').forEach(select => {
                                            ...
                                            if ($select.data('displayStock')) {
                                                $select.on('change', () => {
                                                    const parentForm = $(el.closest(
                                                        'form[data-purchase-form]'));
                                                    changeAmountSelectAndOptions(select,
                                                        parentForm);
                                                    updatePurchaseFormDisabled(parentForm
                                                        .find('#itemSelect'), parentForm
                                                        );
                                                });
                                            }
                                        });
                            ...
                            function changeAmountSelectAndOptions(select, $form) {
                                $form.find('#amountSelectWrap  .amountSelect').css('display', 'none').prop('disabled',
                                    true);
                                ...
                                $amountSelect = $form.find('#amountSelectWrap  .amountSelect:eq(' + $selectedVariation
                                    .attr('data-index') + ')');
                            ...
                            function updatePurchaseFormDisabled($itemSelect, $form) {
                                const isAmountActive = Array.from($itemSelect.find('[name="amount"]')).some((el) => !(el
                        ...
                        <div class="purchaseButton button_add"> 
                                {{-- <button type="submit" class="purchaseButton__btn purchaseButton__btn--outOfStock purchaseButton__btn--requestRestockMail x_restockMailNotificationModalOpen">Add to cart </button> --}}
                            <style>
                                @font-face {
                    ...
                    <p class="explanation" style="word-wrap: break-word;line-height: 1.5em;" itemprop="description">
                        @foreach($data->product_details()->get() as $product_detail)
                            @foreach($attributes as $attribute)
                                @foreach($product_detail->attribute_products()->get() as $attribute_product)
                                    @if($attribute->id == $attribute_product->attribute_id)
                                        <span>{{$attribute->name}} : {{$attribute_product->value}}</span><br>
                                    @endif
                                @endforeach
                            @endforeach
                            Description: {{$product_detail->description}}<br>
                        @endforeach
                    </p>
    ...
    <div id="notes">
        <div id="notesCol">
            <ul class="accordion">
                <li>
                    <div class="menu"><span class="icon"></span>ご利用ガイド</div>
                    <div class="resultList notesBox">
                        <p>BEEPをご利用いただき誠にありがとうございます。<br>
                            <br>
                            以下、問い合わせが多い質問です。必ずお読みになってからご購入下さい。</p>
                        ...
                        <dl>
                            ...
                            <dt>②注文完了メールが届かない場合</dt>
                            <dd>
                                <p>ご注文時に登録されたメールアドレスに間違いがあるか、迷惑メールに入ってしまっている可能性がございます。今一度ご確認をお願いいたします。</p>
                            </dd>
                            <dt>③ご注文キャンセルについて</dt>
                            <dd>
                                <p class="ti">◇発注前の場合</p>
                            ...
                            <dt>④長期不在・住所不備に関して</dt>
                            <dd>
                                <p>お客様がご不在の場合は、ヤマト運輸より不在通知でご連絡いたします。不在通知より、お客様自身で再配達依頼をお願いします。<br>
                                    なお、発送日から7日以上経過した商品は、自動的にキャンセルとなります。予めご了承下さい。</p>
                                <ul class="notes">
                                    <li>※配送先住所に誤りがある場合は、住所不明のため、返送となります。</li>
                                    <li>・番地の記入漏れが多く見受けられますので、ご購入時にご確認をお願いいたします。</li>
                            ...
                            <dt>⑤ショップへのお問合せに関して</dt>
                            <dd>
                                <p>弊社へのお問い合わせは、メールでご連絡をお願いいたします。<a
                                        href="../client_html/mailto:beepinfo@bordi.co.jp">beepinfo@bordi.co.jp</a><br>
                                    お電話をいただいてもサポート対応はできませんので、あらかじめご了承ください。</p>
                            </dd>
                        </dl>
                        <div class="notesBox">
                            <h3>！注意事項！</h3>
                            <ul>
                                <li>１）当店では、在庫の流動性が高く、発注後に在庫切れ、又は発送不良になる場合もございます。万が一、商品が在庫切れ、発送不良の場合は、メールでご連絡いたします。</li>

                                <li>２）商品のお色は、屋内や光源の度合で画像と誤差が出る場合がございます。また、各モニターの特性でも異なる事がありご理解の上ご購入ください。</li>
                ...
                <li>
                    <div class="menu"><span class="icon"></span>お問い合わせ</div>
                    <div class="resultList contactBox">
                        <h3>BEEP カスタマーセンター</h3>
                        <p>お問い合わせにつきましては、以下のメールアドレスにお願いいたします。<br>
                            <a href="../client_html/mailto:beepinfo@bordi.co.jp">beepinfo@bordi.co.jp</a><br>
                            <br>
                            ご不明な点がございましたら、お気軽にお問い合わせくださいませ。<br>
                            <br>
                            営業時間: 午前10:00〜午後17:00 (土日・祝日・年末年始を除く)</p>
                    </div>
                </li>
            </ul>
...
<!-- Mirrored from www.beepsheepshamp.com/categories/1150353 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 28 Dec 2021 01:18:37 GMT -->
